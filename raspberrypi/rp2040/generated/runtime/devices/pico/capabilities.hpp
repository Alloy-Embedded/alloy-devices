...
inline constexpr std::array<CapabilityDescriptor, 57> kCapabilities = {{
...
template<>
struct CapabilityTraits<CapabilityId::capability_instance_i2c0_pico_scl> {
  static constexpr bool kPresent = true;
  static constexpr CapabilityScopeId kScopeId = CapabilityScopeId::instance_overlay;
  static constexpr PeripheralClassId kPeripheralClassId = PeripheralClassId::class_i2c;
  static constexpr CapabilityNameId kNameId = CapabilityNameId::available_signal;
...
template<>
struct CapabilityTraits<CapabilityId::capability_instance_i2c0_pico_sda> {
  static constexpr bool kPresent = true;
  static constexpr CapabilityScopeId kScopeId = CapabilityScopeId::instance_overlay;
  static constexpr PeripheralClassId kPeripheralClassId = PeripheralClassId::class_i2c;
  static constexpr CapabilityNameId kNameId = CapabilityNameId::available_signal;
...
template<>
struct CapabilityTraits<CapabilityId::capability_instance_i2c1_pico_scl> {
  static constexpr bool kPresent = true;
  static constexpr CapabilityScopeId kScopeId = CapabilityScopeId::instance_overlay;
  static constexpr PeripheralClassId kPeripheralClassId = PeripheralClassId::class_i2c;
  static constexpr CapabilityNameId kNameId = CapabilityNameId::available_signal;
...
template<>
struct CapabilityTraits<CapabilityId::capability_instance_i2c1_pico_sda> {
  static constexpr bool kPresent = true;
  static constexpr CapabilityScopeId kScopeId = CapabilityScopeId::instance_overlay;
  static constexpr PeripheralClassId kPeripheralClassId = PeripheralClassId::class_i2c;
  static constexpr CapabilityNameId kNameId = CapabilityNameId::available_signal;
