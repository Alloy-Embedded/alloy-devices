...
void GPIO10_Combined_0_31_IRQHandler() __attribute__((weak));
...
inline constexpr std::array<InterruptStubDescriptor, 158> kInterruptStubs = {{
  ...
  {InterruptId::GPIO10_Combined_0_31, StartupSymbolId::GPIO10_Combined_0_31_IRQHandler, 71u, 87u},
...
template<>
struct InterruptStubTraits<InterruptId::GPIO10_Combined_0_31> {
  static constexpr bool kPresent = true;
  static constexpr StartupSymbolId kSymbolId = StartupSymbolId::GPIO10_Combined_0_31_IRQHandler;
