...
inline constexpr std::array<SystemSequenceStepDescriptor, 6> kSystemSequenceSteps = {{
  ...
  {SystemSequenceId::default_bringup, 1u, SystemSequenceStepKindId::startup_descriptor, StartupDescriptorId::startup_copy_target_ocram, PeripheralId::none, SystemClockProfileId::none, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
  ...
  {SystemSequenceId::default_bringup, 3u, SystemSequenceStepKindId::startup_descriptor, StartupDescriptorId::startup_vectors, PeripheralId::none, SystemClockProfileId::none, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
  {SystemSequenceId::default_bringup, 4u, SystemSequenceStepKindId::startup_descriptor, StartupDescriptorId::startup_zero_target_ocram, PeripheralId::none, SystemClockProfileId::none, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
  {SystemSequenceId::default_bringup, 5u, SystemSequenceStepKindId::system_clock_profile, StartupDescriptorId::none, PeripheralId::none, SystemClockProfileId::default_arm_pll_600mhz, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
}};
...
struct SystemSequenceTraits<SystemSequenceId::default_bringup> {
  ...
  static constexpr std::uint16_t kStartupDescriptorCount = 5u;
  static constexpr std::uint16_t kStartupControlCount = 0u;
