...
struct ConnectorTraits<Pin, PeripheralId::LPSPI1, SignalId::signal_pcs0> {
  ...
  static constexpr RouteKindId kRouteKindId = RouteKindId::none;
  static constexpr ConnectionGroupId kConnectionGroupId = ConnectionGroupId::none;
  static_assert(detail::kInvalidConnector<Pin>, "Invalid connector for LPSPI1 pcs0. Valid pins: GPIO_EMC_01. Provenance: nxp-mcux-sdk; patches=nxp-imxrt1060-family-bootstrap-v1, nxp-imxrt1060-mimxrt1064-bootstrap.");
};
...
struct ConnectorTraits<Pin, PeripheralId::LPSPI1, SignalId::signal_sck> {
  ...
  static constexpr RouteKindId kRouteKindId = RouteKindId::none;
  static constexpr ConnectionGroupId kConnectionGroupId = ConnectionGroupId::none;
  static_assert(detail::kInvalidConnector<Pin>, "Invalid connector for LPSPI1 sck. Valid pins: GPIO_EMC_00. Provenance: nxp-mcux-sdk; patches=nxp-imxrt1060-family-bootstrap-v1, nxp-imxrt1060-mimxrt1064-bootstrap.");
};
...
struct ConnectorTraits<Pin, PeripheralId::LPUART1, SignalId::signal_rx> {
  ...
  static constexpr RouteKindId kRouteKindId = RouteKindId::none;
  static constexpr ConnectionGroupId kConnectionGroupId = ConnectionGroupId::none;
  static_assert(detail::kInvalidConnector<Pin>, "Invalid connector for LPUART1 rx. Valid pins: GPIO_AD_B0_01. Provenance: nxp-mcux-sdk; patches=nxp-imxrt1060-family-bootstrap-v1, nxp-imxrt1060-mimxrt1064-bootstrap.");
};
...
struct ConnectorTraits<Pin, PeripheralId::LPUART1, SignalId::signal_tx> {
  ...
  static constexpr RouteKindId kRouteKindId = RouteKindId::none;
  static constexpr ConnectionGroupId kConnectionGroupId = ConnectionGroupId::none;
  static_assert(detail::kInvalidConnector<Pin>, "Invalid connector for LPUART1 tx. Valid pins: GPIO_AD_B0_00. Provenance: nxp-mcux-sdk; patches=nxp-imxrt1060-family-bootstrap-v1, nxp-imxrt1060-mimxrt1064-bootstrap.");
};
