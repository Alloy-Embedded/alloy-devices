...
inline constexpr VectorSlotDescriptor kVectorSlots[] = {
  ...
  {24, "UCPD1_UCPD2_IRQHandler", "UCPD1_UCPD2", "external-interrupt"},
  ...
  {29, "TIM1_BRK_UP_TRG_COMP_IRQHandler", "TIM1_BRK_UP_TRG_COMP", "external-interrupt"},
  ...
  {34, "TIM7_LPTIM2_IRQHandler", "TIM7_LPTIM2", "external-interrupt"},
  ...
  {45, "USART3_USART4_LPUART1_IRQHandler", "USART3_USART4_LPUART1", "external-interrupt"},
  {46, "CEC_IRQHandler", "CEC", "external-interrupt"},
  {47, "RNG_IRQHandler", "RNG", "external-interrupt"},
};
