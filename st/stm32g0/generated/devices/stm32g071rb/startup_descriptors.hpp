...
inline constexpr std::array<VectorSlotDescriptor, 48> kVectorSlots = {{
  ...
  {24, StartupSymbolId::UCPD1_UCPD2_IRQHandler, InterruptBindingId::interrupt_binding_ucpd1_ucpd1_ucpd2, VectorKindId::vector_kind_external_interrupt},
  ...
  {29, StartupSymbolId::TIM1_BRK_UP_TRG_COMP_IRQHandler, InterruptBindingId::interrupt_binding_tim1_tim1_brk_up_trg_comp, VectorKindId::vector_kind_external_interrupt},
  ...
  {33, StartupSymbolId::TIM6_DAC_LPTIM1_IRQHandler, InterruptBindingId::interrupt_binding_tim6_tim6_dac_lptim1, VectorKindId::vector_kind_external_interrupt},
  {34, StartupSymbolId::TIM7_LPTIM2_IRQHandler, InterruptBindingId::interrupt_binding_tim7_tim7_lptim2, VectorKindId::vector_kind_external_interrupt},
  ...
  {45, StartupSymbolId::USART3_USART4_LPUART1_IRQHandler, InterruptBindingId::interrupt_binding_usart3_usart3_usart4_lpuart1, VectorKindId::vector_kind_external_interrupt},
  ...
  {47, StartupSymbolId::RNG_IRQHandler, InterruptBindingId::interrupt_binding_rng_rng, VectorKindId::vector_kind_external_interrupt},
}};
