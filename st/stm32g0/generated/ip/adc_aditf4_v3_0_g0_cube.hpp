...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_adc_aditf4_v3_0_G0_Cube,
  PeripheralClassId::class_adc,
  BackendSchemaId::schema_alloy_adc_st_aditf4_v3_0_g0_cube,
  RegisterProfileId::register_profile_adc_aditf4_v3_0_G0_Cube,
  0u,
  0u,
};
