...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_crc_integtest1_v2_0,
  PeripheralClassId::class_crc,
  BackendSchemaId::schema_alloy_crc_st_integtest1_v2_0,
  RegisterProfileId::register_profile_crc_integtest1_v2_0,
  0u,
  0u,
};
