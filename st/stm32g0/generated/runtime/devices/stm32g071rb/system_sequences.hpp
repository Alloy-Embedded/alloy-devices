...
inline constexpr std::array<SystemSequenceStepDescriptor, 7> kSystemSequenceSteps = {{
  ...
  {SystemSequenceId::default_bringup, 6u, SystemSequenceStepKindId::system_clock_profile, StartupDescriptorId::none, PeripheralId::none, SystemClockProfileId::safe_hsi16, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
}};
