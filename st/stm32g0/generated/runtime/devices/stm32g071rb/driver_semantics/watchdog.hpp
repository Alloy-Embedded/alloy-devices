...
struct WatchdogSemanticTraits<PeripheralId::IWDG> {
  ...
  static constexpr BackendSchemaId kSchemaId = BackendSchemaId::schema_alloy_watchdog_st_iwdg1_v2_0;
  ...
  static constexpr RuntimeRegisterRef kWindowRegister = RuntimeRegisterRef{RegisterId::register_iwdg_winr, 0x40003000u, 16u, true};
  static constexpr RuntimeFieldRef kEnableField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kDisableField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kRestartField = kInvalidFieldRef;
  ...
  static constexpr RuntimeFieldRef kWindowField = RuntimeFieldRef{FieldId::field_iwdg_winr_win, RuntimeRegisterRef{RegisterId::register_iwdg_winr, 0x40003000u, 16u, true}, 0u, 12u, true};
  ...
  static constexpr RuntimeFieldRef kStatusWindowUpdateField = RuntimeFieldRef{FieldId::field_iwdg_sr_wvu, RuntimeRegisterRef{RegisterId::register_iwdg_sr, 0x40003000u, 12u, true}, 2u, 1u, true};
  static constexpr RuntimeFieldRef kStatusTimeoutField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kStatusErrorField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kRequiredConfigField = kInvalidFieldRef;
};
...
struct WatchdogSemanticTraits<PeripheralId::WWDG> {
  static constexpr bool kPresent = true;
  static constexpr BackendSchemaId kSchemaId = BackendSchemaId::schema_alloy_watchdog_st_wwdg1_v2_0;
  static constexpr bool kHasWindow = true;
  static constexpr std::uint32_t kRequiredConfigValue = 0x00000000u;
  ...
  static constexpr RuntimeFieldRef kPrescalerField = RuntimeFieldRef{FieldId::field_wwdg_cfr_wdgtb, RuntimeRegisterRef{RegisterId::register_wwdg_cfr, 0x40002C00u, 4u, true}, 11u, 3u, true};
