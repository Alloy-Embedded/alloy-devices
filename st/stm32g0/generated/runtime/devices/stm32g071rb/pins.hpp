...
template<>
struct PinTraits<PinId::PF0> {
  static constexpr bool kPresent = true;
  static constexpr PortId kPortId = PortId::port_F;
  static constexpr int kPinNumber = 0;
};

template<>
struct PinTraits<PinId::PF1> {
  static constexpr bool kPresent = true;
  static constexpr PortId kPortId = PortId::port_F;
  static constexpr int kPinNumber = 1;
};
...
template<>
struct PinTraits<PinId::PF2> {
  static constexpr bool kPresent = true;
  static constexpr PortId kPortId = PortId::port_F;
  static constexpr int kPinNumber = 2;
};

inline constexpr std::array<PinId, 60> kPins = {{
  PinId::PA0,
  PinId::PA1,
  PinId::PA10,
  PinId::PA11,
