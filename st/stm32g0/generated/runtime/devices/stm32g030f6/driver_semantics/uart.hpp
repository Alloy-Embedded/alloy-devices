...
struct UartSemanticTraits<PeripheralId::USART2> {
  ...
  static constexpr RuntimeFieldRef kReField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_cr1, 0x40004400u, 0u, true}, 2u, 1u, true};
  static constexpr RuntimeFieldRef kTeField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_cr1, 0x40004400u, 0u, true}, 3u, 1u, true};
  static constexpr RuntimeFieldRef kPceField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_cr1, 0x40004400u, 0u, true}, 10u, 1u, true};
  static constexpr RuntimeFieldRef kPsField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_cr1, 0x40004400u, 0u, true}, 9u, 1u, true};
  static constexpr RuntimeFieldRef kM0Field = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_cr1, 0x40004400u, 0u, true}, 12u, 1u, true};
  static constexpr RuntimeFieldRef kM1Field = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_cr1, 0x40004400u, 0u, true}, 28u, 1u, true};
  static constexpr RuntimeFieldRef kMField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kStopField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_cr2, 0x40004400u, 4u, true}, 12u, 2u, true};
  static constexpr RuntimeFieldRef kTdrField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_tdr, 0x40004400u, 40u, true}, 0u, 9u, true};
  static constexpr RuntimeFieldRef kRdrField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_rdr, 0x40004400u, 36u, true}, 0u, 9u, true};
  static constexpr RuntimeFieldRef kTxeIsrField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_isr, 0x40004400u, 28u, true}, 7u, 1u, true};
  static constexpr RuntimeFieldRef kRxneIsrField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_isr, 0x40004400u, 28u, true}, 5u, 1u, true};
  static constexpr RuntimeFieldRef kTcIsrField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_usart2_isr, 0x40004400u, 28u, true}, 6u, 1u, true};
  static constexpr RuntimeFieldRef kTxeSrField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kRxneSrField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kTcSrField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kDrField = kInvalidFieldRef;
...
template<>
struct UartFifoTriggerOf<PeripheralId::USART2> {
  enum class type : std::uint8_t {
    one_eighth = 0u,
    quarter = 1u,
    half = 2u,
