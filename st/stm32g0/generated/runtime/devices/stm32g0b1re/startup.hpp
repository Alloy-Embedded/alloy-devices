...
enum class InterruptBindingId : std::uint16_t {
  ...
  interrupt_binding_fdcan1_fdcan1_it0,
...
inline constexpr std::array<VectorSlotDescriptor, 21> kVectorSlots = {{
  ...
  {35, StartupSymbolId::FDCAN1_IT0_IRQHandler, InterruptBindingId::interrupt_binding_fdcan1_fdcan1_it0, VectorKindId::vector_kind_external_interrupt},
