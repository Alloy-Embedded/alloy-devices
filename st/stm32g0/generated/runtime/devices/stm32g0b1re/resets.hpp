...
inline constexpr std::array<ResetDescriptor, 12> kResetDescriptors = {{
  ...
  {ResetId::reset_usb, PeripheralId::USB, RegisterId::register_rcc_apbrstr1, FieldId::none, ActiveLevelId::active_level_high},
}};
}
}
}
