...
inline constexpr std::array<EnableDomainDescriptor, 12> kEnableDomains = {{
  ...
  {EnableDomainId::gate_i2c2, PeripheralId::I2C2, ClockGateId::gate_i2c2, ClockNodeId::clock_node_rcc_apbenr1, RegisterId::register_rcc_apbenr1, FieldId::none},
  ...
  {EnableDomainId::gate_usb, PeripheralId::USB, ClockGateId::gate_usb, ClockNodeId::clock_node_rcc_apbenr1, RegisterId::register_rcc_apbenr1, FieldId::none},
}};
