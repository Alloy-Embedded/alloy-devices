...
template<>
struct ClockGateTraits<ClockGateId::gate_i2c3> {
  static constexpr bool kPresent = true;
  static constexpr RegisterId kRegisterId = RegisterId::register_rcc_apbenr1;
...
template<>
struct ResetTraits<ResetId::reset_i2c3> {
  static constexpr bool kPresent = true;
  static constexpr RegisterId kRegisterId = RegisterId::register_rcc_apbrstr1;
  static constexpr FieldId kFieldId = FieldId::field_rcc_apbrstr1_i2c3rst;
  static constexpr ActiveLevelId kActiveLevelId = ActiveLevelId::active_level_high;
};
...
struct PeripheralClockBindingTraits<PeripheralId::I2C3> {
  ...
  static constexpr ResetId kResetId = ResetId::reset_i2c3;
  static constexpr ClockSelectorId kSelectorId = ClockSelectorId::none;
};
...
inline constexpr std::array<PeripheralId, 41> kClockBoundPeripherals = {{
  PeripheralId::ADC1,
  PeripheralId::DAC,
  PeripheralId::DMA1,
  PeripheralId::DMA2,
...
template <>
inline auto clock_enable<PeripheralId::FDCAN1>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg | (1u << 12);
}
template <>
inline auto clock_disable<PeripheralId::FDCAN1>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg & ~(1u << 12);
}

template <>
inline auto clock_enable<PeripheralId::FDCAN2>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg | (1u << 12);
}
template <>
inline auto clock_disable<PeripheralId::FDCAN2>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg & ~(1u << 12);
}
...
template <>
inline auto clock_enable<PeripheralId::I2C3>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg | (1u << 23);
}
template <>
inline auto clock_disable<PeripheralId::I2C3>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg & ~(1u << 23);
}
...
template <>
inline auto clock_enable<PeripheralId::SPI3>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg | (1u << 15);
}
template <>
inline auto clock_disable<PeripheralId::SPI3>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg & ~(1u << 15);
}
...
template <>
inline auto clock_enable<PeripheralId::USART5>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg | (1u << 8);
}
template <>
inline auto clock_disable<PeripheralId::USART5>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg & ~(1u << 8);
}

template <>
inline auto clock_enable<PeripheralId::USART6>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg | (1u << 9);
}
template <>
inline auto clock_disable<PeripheralId::USART6>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg & ~(1u << 9);
}

template <>
inline auto clock_enable<PeripheralId::USB>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg | (1u << 13);
}
template <>
inline auto clock_disable<PeripheralId::USB>() noexcept -> void {
  auto* reg = reinterpret_cast<volatile std::uint32_t*>(0x4002103Cu);
  *reg = *reg & ~(1u << 13);
}
