...
struct SpiSemanticTraits<PeripheralId::SPI3> {
  ...
  static constexpr std::array<KernelClockSourceOption, 0> kKernelClockSourceOptions = {};
  static constexpr std::uint32_t kKernelMaxClockHz = 0u;
  static constexpr RuntimeFieldRef kClockGateField = RuntimeFieldRef{FieldId::field_rcc_apbenr1_spi3en, RuntimeRegisterRef{RegisterId::register_rcc_apbenr1, 0x40021000u, 60u, true}, 15u, 1u, true};
};
