...
inline constexpr std::array<InterruptStubDescriptor, 5> kInterruptStubs = {{
  ...
  {InterruptId::FDCAN1_IT0, StartupSymbolId::FDCAN1_IT0_IRQHandler, 19u, 35u},
...
template<>
struct InterruptStubTraits<InterruptId::FDCAN1_IT0> {
  static constexpr bool kPresent = true;
  static constexpr StartupSymbolId kSymbolId = StartupSymbolId::FDCAN1_IT0_IRQHandler;
