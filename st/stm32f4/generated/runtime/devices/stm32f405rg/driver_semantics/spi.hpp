...
struct SpiSemanticTraits<PeripheralId::SPI1> {
  ...
  static constexpr std::array<std::uint8_t, 2> kSupportedFrameSizes = {{8u, 16u}};
  static constexpr std::array<std::uint8_t, 0> kFifoThresholdBits = {{}};
  ...
  static constexpr bool kSupportsI2sSubmode = true;
  ...
  static constexpr RuntimeFieldRef kClockGateField = RuntimeFieldRef{FieldId::field_rcc_apb2enr_spi1en, RuntimeRegisterRef{RegisterId::register_rcc_apb2enr, 0x40023800u, 68u, true}, 12u, 1u, true};
};
...
struct SpiSemanticTraits<PeripheralId::SPI2> {
  ...
  static constexpr RuntimeFieldRef kClockGateField = RuntimeFieldRef{FieldId::field_rcc_apb1enr_spi2en, RuntimeRegisterRef{RegisterId::register_rcc_apb1enr, 0x40023800u, 64u, true}, 14u, 1u, true};
};
