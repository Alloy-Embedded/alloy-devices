...
struct DacSemanticTraits<PeripheralId::DAC> {
  ...
  static constexpr RuntimeRegisterRef kChannelStatusRegister = RuntimeRegisterRef{RegisterId::register_dac_sr, 0x40007400u, 52u, true};
  static constexpr RuntimeRegisterRef kDataRegister = RuntimeRegisterRef{RegisterId::register_dac_dhr12rd, 0x40007400u, 32u, true};
  static constexpr RuntimeFieldRef kSoftwareResetField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kWordModeField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kPrescalerField = kInvalidFieldRef;
...
struct DacChannelSemanticTraits<PeripheralId::DAC, 0u> {
  static constexpr bool kPresent = true;
  static constexpr RuntimeFieldRef kEnableField = RuntimeFieldRef{FieldId::field_dac_cr_en1, RuntimeRegisterRef{RegisterId::register_dac_cr, 0x40007400u, 0u, true}, 0u, 1u, true};
  static constexpr RuntimeFieldRef kDisableField = RuntimeFieldRef{FieldId::field_dac_cr_en1, RuntimeRegisterRef{RegisterId::register_dac_cr, 0x40007400u, 0u, true}, 0u, 1u, true};
  static constexpr RuntimeFieldRef kReadyField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kTriggerEnableField = RuntimeFieldRef{FieldId::field_dac_cr_ten1, RuntimeRegisterRef{RegisterId::register_dac_cr, 0x40007400u, 0u, true}, 2u, 1u, true};
  static constexpr RuntimeFieldRef kTriggerSelectField = RuntimeFieldRef{FieldId::field_dac_cr_tsel1, RuntimeRegisterRef{RegisterId::register_dac_cr, 0x40007400u, 0u, true}, 3u, 3u, true};
  static constexpr RuntimeFieldRef kDataField = RuntimeFieldRef{FieldId::field_dac_dhr12r1_dacc1dhr, RuntimeRegisterRef{RegisterId::register_dac_dhr12r1, 0x40007400u, 8u, true}, 0u, 12u, true};
};

template<>
struct DacChannelSemanticTraits<PeripheralId::DAC, 1u> {
  static constexpr bool kPresent = true;
  static constexpr RuntimeFieldRef kEnableField = RuntimeFieldRef{FieldId::field_dac_cr_en2, RuntimeRegisterRef{RegisterId::register_dac_cr, 0x40007400u, 0u, true}, 16u, 1u, true};
  static constexpr RuntimeFieldRef kDisableField = RuntimeFieldRef{FieldId::field_dac_cr_en2, RuntimeRegisterRef{RegisterId::register_dac_cr, 0x40007400u, 0u, true}, 16u, 1u, true};
  static constexpr RuntimeFieldRef kReadyField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kTriggerEnableField = RuntimeFieldRef{FieldId::field_dac_cr_ten2, RuntimeRegisterRef{RegisterId::register_dac_cr, 0x40007400u, 0u, true}, 18u, 1u, true};
  static constexpr RuntimeFieldRef kTriggerSelectField = RuntimeFieldRef{FieldId::field_dac_cr_tsel2, RuntimeRegisterRef{RegisterId::register_dac_cr, 0x40007400u, 0u, true}, 19u, 3u, true};
  static constexpr RuntimeFieldRef kDataField = RuntimeFieldRef{FieldId::field_dac_dhr12r2_dacc2dhr, RuntimeRegisterRef{RegisterId::register_dac_dhr12r2, 0x40007400u, 20u, true}, 0u, 12u, true};
};
