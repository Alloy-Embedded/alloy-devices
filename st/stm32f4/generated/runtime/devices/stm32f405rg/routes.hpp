...
inline constexpr std::array<RouteDescriptor, 76> kRuntimeRoutes = {{
...
inline auto apply_route<PinId::PB11, PeripheralId::I2C2, SignalId::signal_sda>() noexcept -> void {
  ...
  *reinterpret_cast<volatile std::uint32_t*>(0x40023820u) &= ~(std::uint32_t{1} << 22);
  *reinterpret_cast<volatile std::uint32_t*>(0x40020400u) = 
      (*reinterpret_cast<volatile std::uint32_t*>(0x40020400u) & ~(std::uint32_t{0x3} << 22)) | (std::uint32_t{0x2} << 22);
  *reinterpret_cast<volatile std::uint32_t*>(0x40020424u) = 
      (*reinterpret_cast<volatile std::uint32_t*>(0x40020424u) & ~(std::uint32_t{0xF} << 12)) | (std::uint32_t{0x4} << 12);
}
...
inline auto apply_route<PinId::PB11, PeripheralId::TIM2, SignalId::signal_ch4>() noexcept -> void {
  ...
  *reinterpret_cast<volatile std::uint32_t*>(0x40020400u) = 
      (*reinterpret_cast<volatile std::uint32_t*>(0x40020400u) & ~(std::uint32_t{0x3} << 22)) | (std::uint32_t{0x2} << 22);
  *reinterpret_cast<volatile std::uint32_t*>(0x40020424u) = 
      (*reinterpret_cast<volatile std::uint32_t*>(0x40020424u) & ~(std::uint32_t{0xF} << 12)) | (std::uint32_t{0x1} << 12);
}
