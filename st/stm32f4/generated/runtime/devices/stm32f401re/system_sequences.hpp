...
inline constexpr std::array<SystemSequenceStepDescriptor, 7> kSystemSequenceSteps = {{
  ...
  {SystemSequenceId::default_bringup, 6u, SystemSequenceStepKindId::system_clock_profile, StartupDescriptorId::none, PeripheralId::none, SystemClockProfileId::default_hse_pll_84mhz, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
}};
...
struct SystemSequenceTraits<SystemSequenceId::default_bringup> {
  ...
  static constexpr std::uint16_t kStartupControlCount = 0u;
  static constexpr SystemClockProfileId kDefaultSystemClockProfileId = SystemClockProfileId::default_hse_pll_84mhz;
  static constexpr SystemClockProfileId kSafeSystemClockProfileId = SystemClockProfileId::safe_reset_default;
};
}
}
}
