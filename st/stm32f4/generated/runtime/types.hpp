...
enum class BackendSchemaId : std::uint16_t {
  ...
  schema_alloy_eth_st_ethernet_dma,
  schema_alloy_eth_st_ethernet_mac,
  schema_alloy_eth_st_ethernet_mmc,
  ...
  schema_alloy_usb_st_otg_fs_device,
  schema_alloy_usb_st_otg_fs_global,
  schema_alloy_usb_st_otg_fs_host,
  schema_alloy_usb_st_otg_fs_pwrclk,
  schema_alloy_usb_st_otg_hs_device,
  schema_alloy_usb_st_otg_hs_global,
  schema_alloy_usb_st_otg_hs_host,
  schema_alloy_usb_st_otg_hs_pwrclk,
