...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_sdio_sdmmc_v1_2_Cube,
  PeripheralClassId::class_sdio,
  BackendSchemaId::schema_alloy_sdio_st_sdmmc_v1_2_cube,
  RegisterProfileId::register_profile_sdio_sdmmc_v1_2_Cube,
  0u,
  0u,
};
