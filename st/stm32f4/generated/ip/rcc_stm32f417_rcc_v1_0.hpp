...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_rcc_STM32F417_rcc_v1_0,
  PeripheralClassId::class_rcc,
  BackendSchemaId::schema_alloy_rcc_st_stm32f417_rcc_v1_0,
  RegisterProfileId::register_profile_rcc_STM32F417_rcc_v1_0,
  0u,
  0u,
};
