...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_nvic_STM32F417,
  PeripheralClassId::class_nvic,
  BackendSchemaId::schema_alloy_nvic_st_stm32f417,
  RegisterProfileId::register_profile_nvic_STM32F417,
  0u,
  0u,
};
