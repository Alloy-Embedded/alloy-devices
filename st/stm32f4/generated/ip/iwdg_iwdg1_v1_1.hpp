...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_iwdg_iwdg1_v1_1,
  PeripheralClassId::class_iwdg,
  BackendSchemaId::schema_alloy_iwdg_st_iwdg1_v1_1,
  RegisterProfileId::register_profile_iwdg_iwdg1_v1_1,
  0u,
  0u,
};
