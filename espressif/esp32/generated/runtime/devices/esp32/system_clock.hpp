...
inline constexpr std::array<SystemClockProfileDescriptor, 2> kSystemClockProfiles = {{
  {SystemClockProfileId::default_pll_240mhz, SystemClockProfileKindId::default_value, SystemClockSourceKindId::pll_internal, 240000000u, 240000000u, 0u, 0u, 80000000u},
  {SystemClockProfileId::safe_rc_fast_8mhz, SystemClockProfileKindId::safe, SystemClockSourceKindId::internal_oscillator, 8000000u, 8000000u, 0u, 0u, 8000000u},
}};
...
template<>
struct SystemClockProfileTraits<SystemClockProfileId::default_pll_240mhz> {
  ...
  static constexpr std::uint32_t kSysclkHz = 240000000u;
  static constexpr std::uint32_t kHclkHz = 240000000u;
  static constexpr std::uint32_t kApb1Hz = 0u;
  static constexpr std::uint32_t kApb2Hz = 0u;
  static constexpr std::uint32_t kPclkHz = 80000000u;
  static constexpr std::uint32_t kSourceHz = 40000000u;
  static constexpr std::uint32_t kAhbPrescaler = 1u;
  static constexpr std::uint32_t kApb1Prescaler = 1u;
  static constexpr std::uint32_t kApb2Prescaler = 1u;
  static constexpr std::uint32_t kOscillatorStartupCycles = 0u;
  ...
  static constexpr std::uint32_t kIpgPrescaler = 1u;
  static constexpr std::uint32_t kPllM = 0u;
  static constexpr std::uint32_t kPllN = 12u;
  static constexpr std::uint32_t kPllP = 0u;
  static constexpr std::uint32_t kPllQ = 0u;
  static constexpr std::uint32_t kPllR = 0u;
  static constexpr std::uint32_t kFlashLatency = 0u;
...
template<>
struct SystemClockProfileTraits<SystemClockProfileId::safe_rc_fast_8mhz> {
  static constexpr bool kPresent = true;
  ...
  static constexpr std::uint32_t kSysclkHz = 8000000u;
  static constexpr std::uint32_t kHclkHz = 8000000u;
  static constexpr std::uint32_t kApb1Hz = 0u;
  static constexpr std::uint32_t kApb2Hz = 0u;
  static constexpr std::uint32_t kPclkHz = 8000000u;
...
inline bool apply_default_system_clock() {
  return apply_system_clock_profile<SystemClockProfileId::default_pll_240mhz>();
}

inline bool apply_safe_system_clock() {
  return apply_system_clock_profile<SystemClockProfileId::safe_rc_fast_8mhz>();
}
}
}
}
