...
struct ConnectorTraits<PinId::GPIO1, PeripheralId::UART0, SignalId::signal_tx> {
  ...
  static constexpr ConnectionGroupId kConnectionGroupId = ConnectionGroupId::group_uart0_qfn48_tx_rx;
};
...
struct ConnectorTraits<Pin, PeripheralId::UART0, SignalId::signal_rx> {
  ...
  static constexpr RouteKindId kRouteKindId = RouteKindId::none;
  static constexpr ConnectionGroupId kConnectionGroupId = ConnectionGroupId::none;
  static_assert(detail::kInvalidConnector<Pin>, "Invalid connector for UART0 rx. Valid pins: GPIO3. Provenance: espressif-svd; patches=espressif-esp32-bootstrap, espressif-esp32-family-bootstrap-v1.");
};
...
struct ConnectorTraits<Pin, PeripheralId::UART0, SignalId::signal_tx> {
  ...
  static constexpr RouteKindId kRouteKindId = RouteKindId::none;
  static constexpr ConnectionGroupId kConnectionGroupId = ConnectionGroupId::none;
  static_assert(detail::kInvalidConnector<Pin>, "Invalid connector for UART0 tx. Valid pins: GPIO1. Provenance: espressif-svd; patches=espressif-esp32-bootstrap, espressif-esp32-family-bootstrap-v1.");
};

inline constexpr std::array<ConnectorDescriptor, 2> kConnectors = {{
  {ConnectorId::candidate_gpio1_uart0_tx, PinId::GPIO1, PeripheralId::UART0, SignalId::signal_tx, RouteId::candidate_gpio1_uart0_tx, RouteKindId::route_kind_mux, ConnectionGroupId::group_uart0_qfn48_tx_rx},
  {ConnectorId::candidate_gpio3_uart0_rx, PinId::GPIO3, PeripheralId::UART0, SignalId::signal_rx, RouteId::candidate_gpio3_uart0_rx, RouteKindId::route_kind_mux, ConnectionGroupId::group_uart0_qfn48_tx_rx},
}};
}
}
}
