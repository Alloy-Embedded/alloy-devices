...
inline constexpr std::array<SystemClockProfileDescriptor, 2> kSystemClockProfiles = {{
  {SystemClockProfileId::default_pll_160mhz, SystemClockProfileKindId::default_value, SystemClockSourceKindId::pll_internal, 160000000u, 160000000u, 0u, 0u, 80000000u},
...
template<>
struct SystemClockProfileTraits<SystemClockProfileId::default_pll_160mhz> {
  ...
  static constexpr std::uint32_t kSysclkHz = 160000000u;
  static constexpr std::uint32_t kHclkHz = 160000000u;
  static constexpr std::uint32_t kApb1Hz = 0u;
  static constexpr std::uint32_t kApb2Hz = 0u;
...
inline bool apply_default_system_clock() {
  return apply_system_clock_profile<SystemClockProfileId::default_pll_160mhz>();
}
