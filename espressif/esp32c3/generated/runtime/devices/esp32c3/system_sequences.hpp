...
inline constexpr std::array<SystemSequenceStepDescriptor, 9> kSystemSequenceSteps = {{
  ...
  {SystemSequenceId::default_bringup, 8u, SystemSequenceStepKindId::system_clock_profile, StartupDescriptorId::none, PeripheralId::none, SystemClockProfileId::default_pll_160mhz},
}};
