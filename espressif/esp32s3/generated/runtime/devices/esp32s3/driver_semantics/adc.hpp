...
struct AdcSemanticTraits<PeripheralId::APB_SARADC> {
  ...
  static constexpr std::uint32_t kChannelCount = 10u;
  ...
  static constexpr RuntimeRegisterRef kStatusRegister = RuntimeRegisterRef{RegisterId::register_apb_saradc_int_st, 0x60040000u, 100u, true};
  ...
  static constexpr RuntimeRegisterRef kSequenceRegister = RuntimeRegisterRef{RegisterId::none, 0x60040000u, 24u, true};
  ...
  static constexpr RuntimeFieldRef kEnableField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kDisableField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kReadyField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_apb_saradc_int_st, 0x60040000u, 100u, true}, 31u, 1u, true};
  ...
  static constexpr RuntimeFieldRef kExternalTriggerEnableField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kExternalTriggerSelectField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kEndOfConversionField = RuntimeFieldRef{FieldId::none, RuntimeRegisterRef{RegisterId::register_apb_saradc_int_st, 0x60040000u, 100u, true}, 31u, 1u, true};
  static constexpr RuntimeFieldRef kEndOfSequenceField = kInvalidFieldRef;
  static constexpr RuntimeFieldRef kOverrunField = kInvalidFieldRef;
  ...
  static constexpr std::array<InternalAdcChannel, 1> kInternalChannels = {{
    InternalAdcChannel{InternalAdcChannelKind::temperature_sensor, 14u, true},
  }};
  static constexpr std::uint32_t kCalibrationDataPointCount = 0u;
  static constexpr std::array<CalibrationDataPoint, 0> kCalibrationDataPoints = {};
  ...
  static constexpr std::array<AdcResolutionOption, 2> kSupportedResolutions = {{
    ...
    AdcResolutionOption{13u, 1u, true},
  }};
  static constexpr std::uint32_t kSupportedSampleTimeCount = 0u;
  static constexpr std::array<AdcSampleTimeOption, 0> kSupportedSampleTimes = {};
  static constexpr std::uint32_t kSupportedOversamplingCount = 0u;
