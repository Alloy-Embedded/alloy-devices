...
struct SpiSemanticTraits<PeripheralId::SPI2> {
  ...
  static constexpr std::int16_t kIomuxMosiPin = 11;
  static constexpr std::int16_t kIomuxMisoPin = 13;
  static constexpr std::int16_t kIomuxClkPin = 12;
  static constexpr std::int16_t kIomuxCsPin = 10;
...
template<>
struct SpiPrescalerOf<PeripheralId::SPI3> {
  enum class type : std::uint8_t {
    div_2 = 0u,
    div_4 = 1u,
    div_8 = 2u,
...
template<>
struct SpiFrameSizeOf<PeripheralId::SPI3> {
  enum class type : std::uint8_t {
    bits_4 = 0u,
    bits_8 = 1u,
    bits_16 = 2u,
