...
enum class CapabilityId : std::uint16_t {
  ...
  capability_i2c_esp32s3_i2c_v1_scl,
  capability_i2c_esp32s3_i2c_v1_sda,
  runtime_support_i2c,
  capability_instance_i2c0_qfn56_scl,
  capability_instance_i2c0_qfn56_sda,
  capability_spi_esp32s3_spi_v1_cs,
  capability_spi_esp32s3_spi_v1_miso,
  capability_spi_esp32s3_spi_v1_mosi,
  capability_spi_esp32s3_spi_v1_sck,
  runtime_support_spi,
  runtime_dma_SPI2_DMA_SPI2_RX_RX,
  runtime_dma_SPI2_DMA_SPI2_TX_TX,
  capability_instance_spi2_qfn56_cs,
  capability_instance_spi2_qfn56_miso,
  capability_instance_spi2_qfn56_mosi,
  capability_instance_spi2_qfn56_sck,
  capability_uart_esp32s3_uart_v1_rx,
  capability_uart_esp32s3_uart_v1_tx,
  ...
  capability_instance_uart2_qfn56_rx,
  capability_instance_uart2_qfn56_tx,
  runtime_support_usb,
};
...
enum class CapabilityValueId : std::uint16_t {
  ...
  RX,
  TX,
  _register_system_core_1_control_0_register_system_core_1_control_1_,
  cs,
  miso,
  mosi,
  rx,
...
inline constexpr std::array<CapabilityDescriptor, 33> kCapabilities = {{
  ...
  {CapabilityId::device_secondary_core_release_register, CapabilityScopeId::device, PeripheralClassId::class_device, CapabilityNameId::secondary_core_release_register, CapabilityValueId::_register_system_core_1_control_0_register_system_core_1_control_1_, PeripheralId::none},
  ...
  {CapabilityId::capability_i2c_esp32s3_i2c_v1_scl, CapabilityScopeId::ip_block, PeripheralClassId::class_i2c, CapabilityNameId::signal_role, CapabilityValueId::scl, PeripheralId::none},
  {CapabilityId::capability_i2c_esp32s3_i2c_v1_sda, CapabilityScopeId::ip_block, PeripheralClassId::class_i2c, CapabilityNameId::signal_role, CapabilityValueId::sda, PeripheralId::none},
  ...
  {CapabilityId::capability_spi_esp32s3_spi_v1_cs, CapabilityScopeId::ip_block, PeripheralClassId::class_spi, CapabilityNameId::signal_role, CapabilityValueId::cs, PeripheralId::none},
  {CapabilityId::capability_spi_esp32s3_spi_v1_miso, CapabilityScopeId::ip_block, PeripheralClassId::class_spi, CapabilityNameId::signal_role, CapabilityValueId::miso, PeripheralId::none},
  {CapabilityId::capability_spi_esp32s3_spi_v1_mosi, CapabilityScopeId::ip_block, PeripheralClassId::class_spi, CapabilityNameId::signal_role, CapabilityValueId::mosi, PeripheralId::none},
  {CapabilityId::capability_spi_esp32s3_spi_v1_sck, CapabilityScopeId::ip_block, PeripheralClassId::class_spi, CapabilityNameId::signal_role, CapabilityValueId::sck, PeripheralId::none},
  ...
  {CapabilityId::capability_instance_spi2_qfn56_cs, CapabilityScopeId::instance_overlay, PeripheralClassId::class_spi, CapabilityNameId::available_signal, CapabilityValueId::cs, PeripheralId::SPI2},
  {CapabilityId::capability_instance_spi2_qfn56_miso, CapabilityScopeId::instance_overlay, PeripheralClassId::class_spi, CapabilityNameId::available_signal, CapabilityValueId::miso, PeripheralId::SPI2},
  {CapabilityId::capability_instance_spi2_qfn56_mosi, CapabilityScopeId::instance_overlay, PeripheralClassId::class_spi, CapabilityNameId::available_signal, CapabilityValueId::mosi, PeripheralId::SPI2},
  {CapabilityId::capability_instance_spi2_qfn56_sck, CapabilityScopeId::instance_overlay, PeripheralClassId::class_spi, CapabilityNameId::available_signal, CapabilityValueId::sck, PeripheralId::SPI2},
  {CapabilityId::capability_uart_esp32s3_uart_v1_rx, CapabilityScopeId::ip_block, PeripheralClassId::class_uart, CapabilityNameId::signal_role, CapabilityValueId::rx, PeripheralId::none},
  {CapabilityId::capability_uart_esp32s3_uart_v1_tx, CapabilityScopeId::ip_block, PeripheralClassId::class_uart, CapabilityNameId::signal_role, CapabilityValueId::tx, PeripheralId::none},
  ...
  {CapabilityId::capability_instance_uart2_qfn56_rx, CapabilityScopeId::instance_overlay, PeripheralClassId::class_uart, CapabilityNameId::available_signal, CapabilityValueId::rx, PeripheralId::UART2},
  {CapabilityId::capability_instance_uart2_qfn56_tx, CapabilityScopeId::instance_overlay, PeripheralClassId::class_uart, CapabilityNameId::available_signal, CapabilityValueId::tx, PeripheralId::UART2},
...
inline constexpr std::array<CapabilityHardwareLut, 33> kCapabilityHardwareLut = {{
  ...
  {CapabilityScopeId::device, PeripheralClassId::class_device, CapabilityNameId::core_count, CapabilityValueId::_2, PeripheralId::none},
  {CapabilityScopeId::device, PeripheralClassId::class_device, CapabilityNameId::multicore_topology, CapabilityValueId::xtensa_dual_core, PeripheralId::none},
  {CapabilityScopeId::device, PeripheralClassId::class_device, CapabilityNameId::secondary_core_release_register, CapabilityValueId::_register_system_core_1_control_0_register_system_core_1_control_1_, PeripheralId::none},
  ...
  {CapabilityScopeId::instance_overlay, PeripheralClassId::class_uart, CapabilityNameId::available_signal, CapabilityValueId::rx, PeripheralId::UART2},
  {CapabilityScopeId::instance_overlay, PeripheralClassId::class_uart, CapabilityNameId::available_signal, CapabilityValueId::tx, PeripheralId::UART2},
...
template<> struct CapabilityTraits<CapabilityId::device_secondary_core_release_register> : CapabilityTraitsBase<4> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_dma> : CapabilityTraitsBase<5> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_gpio> : CapabilityTraitsBase<6> {};
template<> struct CapabilityTraits<CapabilityId::capability_i2c_esp32s3_i2c_v1_scl> : CapabilityTraitsBase<7> {};
template<> struct CapabilityTraits<CapabilityId::capability_i2c_esp32s3_i2c_v1_sda> : CapabilityTraitsBase<8> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_i2c> : CapabilityTraitsBase<9> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_i2c0_qfn56_scl> : CapabilityTraitsBase<10> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_i2c0_qfn56_sda> : CapabilityTraitsBase<11> {};
template<> struct CapabilityTraits<CapabilityId::capability_spi_esp32s3_spi_v1_cs> : CapabilityTraitsBase<12> {};
template<> struct CapabilityTraits<CapabilityId::capability_spi_esp32s3_spi_v1_miso> : CapabilityTraitsBase<13> {};
template<> struct CapabilityTraits<CapabilityId::capability_spi_esp32s3_spi_v1_mosi> : CapabilityTraitsBase<14> {};
template<> struct CapabilityTraits<CapabilityId::capability_spi_esp32s3_spi_v1_sck> : CapabilityTraitsBase<15> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_spi> : CapabilityTraitsBase<16> {};
template<> struct CapabilityTraits<CapabilityId::runtime_dma_SPI2_DMA_SPI2_RX_RX> : CapabilityTraitsBase<17> {};
template<> struct CapabilityTraits<CapabilityId::runtime_dma_SPI2_DMA_SPI2_TX_TX> : CapabilityTraitsBase<18> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_spi2_qfn56_cs> : CapabilityTraitsBase<19> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_spi2_qfn56_miso> : CapabilityTraitsBase<20> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_spi2_qfn56_mosi> : CapabilityTraitsBase<21> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_spi2_qfn56_sck> : CapabilityTraitsBase<22> {};
template<> struct CapabilityTraits<CapabilityId::capability_uart_esp32s3_uart_v1_rx> : CapabilityTraitsBase<23> {};
template<> struct CapabilityTraits<CapabilityId::capability_uart_esp32s3_uart_v1_tx> : CapabilityTraitsBase<24> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_uart> : CapabilityTraitsBase<25> {};
template<> struct CapabilityTraits<CapabilityId::runtime_dma_UART0_DMA_UART0_RX_RX> : CapabilityTraitsBase<26> {};
template<> struct CapabilityTraits<CapabilityId::runtime_dma_UART0_DMA_UART0_TX_TX> : CapabilityTraitsBase<27> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_uart0_qfn56_rx> : CapabilityTraitsBase<28> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_uart0_qfn56_tx> : CapabilityTraitsBase<29> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_uart2_qfn56_rx> : CapabilityTraitsBase<30> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_uart2_qfn56_tx> : CapabilityTraitsBase<31> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_usb> : CapabilityTraitsBase<32> {};
...
struct PeripheralClassCapabilityTraits<PeripheralClassId::class_i2c> {
  ...
  inline static constexpr std::array<CapabilityId, 5> kCapabilityIds = {{
    CapabilityId::capability_i2c_esp32s3_i2c_v1_scl,
    CapabilityId::capability_i2c_esp32s3_i2c_v1_sda,
...
struct PeripheralClassCapabilityTraits<PeripheralClassId::class_spi> {
  ...
  inline static constexpr std::array<CapabilityId, 11> kCapabilityIds = {{
    CapabilityId::capability_spi_esp32s3_spi_v1_cs,
    CapabilityId::capability_spi_esp32s3_spi_v1_miso,
    CapabilityId::capability_spi_esp32s3_spi_v1_mosi,
    CapabilityId::capability_spi_esp32s3_spi_v1_sck,
    CapabilityId::runtime_support_spi,
    CapabilityId::runtime_dma_SPI2_DMA_SPI2_RX_RX,
    CapabilityId::runtime_dma_SPI2_DMA_SPI2_TX_TX,
    CapabilityId::capability_instance_spi2_qfn56_cs,
    CapabilityId::capability_instance_spi2_qfn56_miso,
    CapabilityId::capability_instance_spi2_qfn56_mosi,
    CapabilityId::capability_instance_spi2_qfn56_sck,
  }};
};
...
struct PeripheralClassCapabilityTraits<PeripheralClassId::class_uart> {
  ...
  inline static constexpr std::array<CapabilityId, 9> kCapabilityIds = {{
    CapabilityId::capability_uart_esp32s3_uart_v1_rx,
    CapabilityId::capability_uart_esp32s3_uart_v1_tx,
    ...
    CapabilityId::capability_instance_uart2_qfn56_rx,
    CapabilityId::capability_instance_uart2_qfn56_tx,
  }};
};
...
template<>
struct PeripheralCapabilityTraits<PeripheralId::USB0> {
  static constexpr bool kPresent = false;
  inline static constexpr std::array<CapabilityId, 0> kCapabilityIds = {{
  }};
};
