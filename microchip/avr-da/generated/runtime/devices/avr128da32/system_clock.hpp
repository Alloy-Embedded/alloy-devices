...
inline constexpr std::array<SystemClockProfileDescriptor, 2> kSystemClockProfiles = {{
  {SystemClockProfileId::default_osc20m_24mhz, SystemClockProfileKindId::default_value, SystemClockSourceKindId::internal_oscillator, 24000000u, 24000000u, 0u, 0u, 24000000u},
  {SystemClockProfileId::safe_osc20m_20mhz, SystemClockProfileKindId::safe, SystemClockSourceKindId::internal_oscillator, 20000000u, 20000000u, 0u, 0u, 20000000u},
}};
...
template<>
struct SystemClockProfileTraits<SystemClockProfileId::default_osc20m_24mhz> {
...
template<>
struct SystemClockProfileTraits<SystemClockProfileId::safe_osc20m_20mhz> {
  static constexpr bool kPresent = true;
  static constexpr SystemClockProfileKindId kKindId = SystemClockProfileKindId::safe;
  static constexpr SystemClockSourceKindId kSourceKindId = SystemClockSourceKindId::internal_oscillator;
  static constexpr std::uint32_t kSysclkHz = 20000000u;
  static constexpr std::uint32_t kHclkHz = 20000000u;
  static constexpr std::uint32_t kApb1Hz = 0u;
  static constexpr std::uint32_t kApb2Hz = 0u;
  static constexpr std::uint32_t kPclkHz = 20000000u;
  static constexpr std::uint32_t kSourceHz = 20000000u;
  static constexpr std::uint32_t kAhbPrescaler = 1u;
  static constexpr std::uint32_t kApb1Prescaler = 1u;
  static constexpr std::uint32_t kApb2Prescaler = 1u;
  static constexpr std::uint32_t kOscillatorStartupCycles = 0u;
...
inline bool apply_default_system_clock() {
  return apply_system_clock_profile<SystemClockProfileId::default_osc20m_24mhz>();
}

inline bool apply_safe_system_clock() {
  return apply_system_clock_profile<SystemClockProfileId::safe_osc20m_20mhz>();
}
}
}
}
