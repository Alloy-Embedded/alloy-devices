...
inline constexpr std::array<SystemSequenceStepDescriptor, 7> kSystemSequenceSteps = {{
  {SystemSequenceId::default_bringup, 0u, SystemSequenceStepKindId::startup_descriptor, StartupDescriptorId::startup_copy_source_app_section, PeripheralId::none, SystemClockProfileId::none, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
  {SystemSequenceId::default_bringup, 1u, SystemSequenceStepKindId::startup_descriptor, StartupDescriptorId::startup_copy_target_internal_sram, PeripheralId::none, SystemClockProfileId::none, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
  ...
  {SystemSequenceId::default_bringup, 3u, SystemSequenceStepKindId::startup_descriptor, StartupDescriptorId::startup_vector_source_app_section, PeripheralId::none, SystemClockProfileId::none, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
  ...
  {SystemSequenceId::default_bringup, 5u, SystemSequenceStepKindId::startup_descriptor, StartupDescriptorId::startup_zero_target_internal_sram, PeripheralId::none, SystemClockProfileId::none, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
  {SystemSequenceId::default_bringup, 6u, SystemSequenceStepKindId::system_clock_profile, StartupDescriptorId::none, PeripheralId::none, SystemClockProfileId::default_osc20m_24mhz, RegisterId::none, RegisterId::none, SecondaryCoreReleaseOperationId::none},
}};
...
struct SystemSequenceTraits<SystemSequenceId::default_bringup> {
  ...
  static constexpr std::uint16_t kStartupControlCount = 0u;
  static constexpr SystemClockProfileId kDefaultSystemClockProfileId = SystemClockProfileId::default_osc20m_24mhz;
  static constexpr SystemClockProfileId kSafeSystemClockProfileId = SystemClockProfileId::safe_osc20m_20mhz;
};
}
}
}
