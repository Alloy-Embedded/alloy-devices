...
inline constexpr std::array<EnableDomainDescriptor, 30> kEnableDomains = {{
  ...
  {EnableDomainId::gate_spi1, PeripheralId::SPI1, ClockGateId::gate_spi1, ClockNodeId::clock_node_pmc, RegisterId::register_pmc_pcer1, FieldId::field_pmc_pcer1_pid42},
...
struct EnableDomainTraits<EnableDomainId::gate_gpioc> {
  ...
  static constexpr ClockNodeId kParentClockNodeId = ClockNodeId::clock_node_pmc;
  static constexpr RegisterId kRegisterId = RegisterId::register_pmc_pcer0;
  static constexpr FieldId kFieldId = FieldId::field_pmc_pcer0_pid12;
};
...
template<>
struct EnableDomainTraits<EnableDomainId::gate_gpioe> {
  static constexpr bool kPresent = true;
  static constexpr PeripheralId kPeripheralId = PeripheralId::GPIOE;
  static constexpr ClockGateId kClockGateId = ClockGateId::gate_gpioe;
  static constexpr ClockNodeId kParentClockNodeId = ClockNodeId::clock_node_pmc;
  static constexpr RegisterId kRegisterId = RegisterId::register_pmc_pcer0;
  static constexpr FieldId kFieldId = FieldId::field_pmc_pcer0_pid17;
};

template<>
struct PeripheralEnableDomainTraits<PeripheralId::GPIOE> {
  static constexpr bool kPresent = true;
  static constexpr EnableDomainId kEnableDomainId = EnableDomainId::gate_gpioe;
};
...
struct EnableDomainTraits<EnableDomainId::gate_spi1> {
  ...
  static constexpr ClockNodeId kParentClockNodeId = ClockNodeId::clock_node_pmc;
  static constexpr RegisterId kRegisterId = RegisterId::register_pmc_pcer1;
  static constexpr FieldId kFieldId = FieldId::field_pmc_pcer1_pid42;
};
