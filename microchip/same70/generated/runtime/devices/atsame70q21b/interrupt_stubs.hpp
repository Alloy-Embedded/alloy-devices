...
void PIOC_IRQHandler() __attribute__((weak));
...
void PIOE_IRQHandler() __attribute__((weak));
...
void I2SC1_IRQHandler() __attribute__((weak));
...
inline constexpr std::array<InterruptStubDescriptor, 69> kInterruptStubs = {{
  ...
  {InterruptId::PIOC, StartupSymbolId::PIOC_IRQHandler, 12u, 28u},
  ...
  {InterruptId::PIOE, StartupSymbolId::PIOE_IRQHandler, 17u, 33u},
  ...
  {InterruptId::SPI1, StartupSymbolId::SPI1_IRQHandler, 42u, 58u},
  ...
  {InterruptId::I2SC1, StartupSymbolId::I2SC1_IRQHandler, 70u, 86u},
...
template<>
struct InterruptStubTraits<InterruptId::PIOC> {
  static constexpr bool kPresent = true;
  static constexpr StartupSymbolId kSymbolId = StartupSymbolId::PIOC_IRQHandler;
...
template<>
struct InterruptStubTraits<InterruptId::PIOE> {
  static constexpr bool kPresent = true;
  static constexpr StartupSymbolId kSymbolId = StartupSymbolId::PIOE_IRQHandler;
...
template<>
struct InterruptStubTraits<InterruptId::I2SC1> {
  static constexpr bool kPresent = true;
  static constexpr StartupSymbolId kSymbolId = StartupSymbolId::I2SC1_IRQHandler;
