...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_lockbit_lockbit_1,
  PeripheralClassId::class_lockbit,
  BackendSchemaId::schema_alloy_lockbit_microchip_lockbit_1,
  RegisterProfileId::register_profile_lockbit_lockbit_1,
  0u,
  0u,
};
