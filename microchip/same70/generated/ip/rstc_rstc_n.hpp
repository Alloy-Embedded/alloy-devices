...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_rstc_rstc_n,
  PeripheralClassId::class_rstc,
  BackendSchemaId::schema_alloy_rstc_microchip_rstc_n,
  RegisterProfileId::register_profile_rstc_rstc_n,
  0u,
  0u,
};
