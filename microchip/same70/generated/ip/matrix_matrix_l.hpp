...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_matrix_matrix_l,
  PeripheralClassId::class_matrix,
  BackendSchemaId::schema_alloy_matrix_microchip_matrix_l,
  RegisterProfileId::register_profile_matrix_matrix_l,
  0u,
  0u,
};
