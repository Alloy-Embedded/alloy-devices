...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_utmi_utmi_a,
  PeripheralClassId::class_utmi,
  BackendSchemaId::schema_alloy_utmi_microchip_utmi_a,
  RegisterProfileId::register_profile_utmi_utmi_a,
  0u,
  0u,
};
