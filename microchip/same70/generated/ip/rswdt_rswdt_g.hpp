...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_rswdt_rswdt_g,
  PeripheralClassId::class_rswdt,
  BackendSchemaId::schema_alloy_rswdt_microchip_rswdt_g,
  RegisterProfileId::register_profile_rswdt_rswdt_g,
  0u,
  0u,
};
