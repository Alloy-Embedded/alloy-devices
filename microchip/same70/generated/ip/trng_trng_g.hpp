...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_trng_trng_g,
  PeripheralClassId::class_trng,
  BackendSchemaId::schema_alloy_trng_microchip_trng_g,
  RegisterProfileId::register_profile_trng_trng_g,
  0u,
  0u,
};
