...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_gpbr_gpbr_j,
  PeripheralClassId::class_gpbr,
  BackendSchemaId::schema_alloy_gpbr_microchip_gpbr_j,
  RegisterProfileId::register_profile_gpbr_gpbr_j,
  0u,
  0u,
};
