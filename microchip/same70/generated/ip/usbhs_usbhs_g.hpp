...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_usbhs_usbhs_g,
  PeripheralClassId::class_usbhs,
  BackendSchemaId::schema_alloy_usbhs_microchip_usbhs_g,
  RegisterProfileId::register_profile_usbhs_usbhs_g,
  0u,
  0u,
};
